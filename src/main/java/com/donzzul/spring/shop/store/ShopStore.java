...
public interface ShopStore {
	...
	public ArrayList<Shop> selectShopMap(PageInfo pi, HashMap<String, String> selectedLocation); // 지역별 지도 검색
	public ArrayList<Shop> selectShopMap(HashMap<String, String> selectedLocation); // 지역별 지도 검색
