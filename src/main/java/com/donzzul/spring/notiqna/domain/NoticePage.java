...
public class NoticePage {
	...
	public NoticePage(int currentPage, int boardLimit, int pageLimit, int startPage, int endPage, int listCount,
			int maxPage) {
		super();
	...
	public String toString() {
		return "QnaPage [currentPage=" + currentPage + ", boardLimit=" + boardLimit + ", pageLimit=" + pageLimit
