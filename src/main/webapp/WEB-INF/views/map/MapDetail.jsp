				...
				$.ajax({
					...
					success: function(data) {
						...
						if(data.mList.length > 0) { 
							...
							for(var i = 0; i < data.marMarkers; i++) {
								var shopMap = new Object();
								
								shopMap.shopNo = data.marMarkers[i].getShopNo;
								shopMap.shopName = data.marMarkers[i].getShopName;
								shopMap.shopShortAddr = data.marMarkers[i].getShopShortAddr;
								shopMap.shopAddr = data.marMarkers[i].getShopAddr;
								shopMap.startTime = data.marMarkers[i].getStartTime;
								shopMap.endTime = data.marMarkers[i].getEndTime;
								shopMap.businessDay = data.marMarkers[i].getBusinessDay;
								shopMap.shopTarget = data.marMarkers[i].getShopTarget;
								shopMap.shopProduct = data.marMarkers[i].getShopProduct;
