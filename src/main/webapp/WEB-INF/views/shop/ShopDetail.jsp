							...
							<div class="menu-img-frame">
								<c:forEach items="${mPhoto }" var="photo" varStatus="status">
									<div class="detail-right menu-img menu-img-thumb-div"> <!-- 이미지파일 여러개 생성 ( 미리보기 가능 ) ( 최대 몇개 ? ) -->
										<img src="/resources/partnerUploadFiles/menuPhoto/${photo.menuFileName }" id="menu-img-thumb" class="menu-img-thumb" alt="menuImg">
									</div> 
									<div id="img-modal" title="클릭하면 창이 닫힙니다." onclick="imgModalClose();" class="detail-right menu-img menu-img-detail-div modal">
									   <span>X</span>
