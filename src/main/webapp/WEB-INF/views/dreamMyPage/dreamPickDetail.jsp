			...
			success : function(data) {
				if(data != null){
					...
					if(data.pi.currentPage > 1) { //현재페이지가 1보다 크면 (2, 3, 4...)- 이전버튼 활성화
						...
						tdNavi.append("<a href='pickListByDream.dz?page="+prev+"'>[이전]</a>&nbsp;");
					}else {
						tdNavi.append("[이전]&nbsp;");
					}
